...
class CfReg(object):
  ...
  def __init__(self,argin, argout):
    ...
    self.nemo_ncgridfile="/projects/ukesm/rsmith/ancils/cf_gridfile_BISICLES_lev0-AIS.nc" # 768 x 768
    self.bike_ncgridfile="/projects/ukesm/rsmith/ancils/cf_gridfile_BISICLES_lev2.nc-zbot" # 362 x 332
    ...
    self.melt_water=np.transpose(Dataset(self.nctgridfile).variables['melt_water'][:])
    self.melt_heat=np.transpose(Dataset(self.nctgridfile).variables['melt_heat'][:])

    print type(self.melt_water)
...
if __name__ == '__main__':
   ...
   fileout='slopeRegtoCF_lev2.hdf5'
